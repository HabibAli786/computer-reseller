...
describe('add item to cart while logged in', () => {
	test('add item 1 to cart', async done => {
		...
		expect( await page.evaluate( () => document.querySelector('div.col-12 h1').innerText ) )
			.toBe('Acer Predator Orion 5000 Gaming PC')
		// grab a screenshot

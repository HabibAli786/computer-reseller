...
describe('Registering new user and logging into that account', () => {
	test('Register a user', async done => {
		...
		await page.type('input[name=address]', '198 new road')
		...
		await page.click('input[type=submit]')
		//ASSERT
		//check that the user is taken to the user account after attempting to login as the new user:
